...
const UUID = process.env.UUID || 'a4c6e14e-5230-472e-b8db-070858cf466e'; //若需要改UUID，需要在config.json里改为一致
const NEZHA_SERVER = process.env.NEZHA_SERVER || '';     
const NEZHA_PORT = process.env.NEZHA_PORT || '';                     // 哪吒端口为{443,8443,2096,2087,2083,2053}其中之一开启tls
const NEZHA_KEY = process.env.NEZHA_KEY || '';
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || 'year.gamesonline.us.kg';     // 建议使用token，argo端口8080，cf后台设置需对应,使用json需上传json和yml文件至files目录
const ARGO_AUTH = process.env.ARGO_AUTH || 'eyJhIjoiMjM0ODRkZjk2ZmM3ZjY2MjEzMThlMWVlYjNiNjk3ZjUiLCJ0IjoiNDdjODQ3NDUtNzNmNy00NDk1LThhN2YtZGIwMmJjYTc4NzQ0IiwicyI6Ik1UYzBNMll6T1dFdE16QTVPUzAwWW1OaUxUbGpOemt0TlRGbVpqTTRNVEppT0RVMyJ9';

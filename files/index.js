...
const UUID = process.env.UUID || '9a9910c0-d411-409d-9046-8c57c1067a62'; //若需要改UUID，需要在config.json里改为一致
...
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || 'chore0.checkthepaper.us.kg';     // 建议使用token，argo端口8080，cf后台设置需对应,使用json需上传json和yml文件至files目录
const ARGO_AUTH = process.env.ARGO_AUTH || 'eyJhIjoiMjM0ODRkZjk2ZmM3ZjY2MjEzMThlMWVlYjNiNjk3ZjUiLCJ0IjoiMTFmYjFiMjgtYTEzZC00OTRmLWFhZjItYWEzMWQxMTAzZDBmIiwicyI6Ill6ZGhaVGcxTTJVdFpqUXdNQzAwWmpBNExUaGpPV0l0TkRnME56WTNNbVE1TWpWbCJ9';
